package com.st.smartrash.member.model.vo;
...
public class Member implements java.io.Serializable {
	...
	// 마이바티스 매퍼의 resultMap이 자동 작동 실행됨
	...
	public Member(String userid, String userpwd, String username, char gender, int age, String phone, String email,
			String hobby, String etc, Date enroll_date, Date lastmodified, char login_ok, char admin) {
		super();
		this.userid = userid;
